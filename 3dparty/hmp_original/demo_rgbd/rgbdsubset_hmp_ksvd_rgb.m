...
if category
   ...
   for i = 1:trail
       ...
       save(['./rgbdsubset_rgb_acc_c_' num2str(dic_first.patchsize) 'x' num2str(dic_first.patchsize) '_second.mat'],'acc_c', 'predictlabel', 'testlabel');
...
if instance
   ...
   save(['./rgbdsubset_rgb_acc_i_' num2str(dic_first.patchsize) 'x' num2str(dic_first.patchsize) '_second.mat'],'acc_i', 'predictlabel', 'testlabel');
