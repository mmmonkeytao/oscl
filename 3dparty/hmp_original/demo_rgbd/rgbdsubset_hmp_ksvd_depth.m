...
type{1} = 'depthcrop'; type{2} = 'normal';
...
for i = 1:length(type)
    ...
    fea_first.savedir = [saveroot '/rgbdsubset_hmp_fea_' num2str(dic_first.patchsize) 'x' num2str(dic_first.patchsize) '_' fea_first.type];
    ...
    if ~length(rgbdfeapath)
       ...
       dic_first.dic = dic;
       save(['./rgbdsubset_dic_' num2str(dic_first.patchsize) 'x' num2str(dic_first.patchsize) '_' fea_first.type '.mat'],'dic');
...
if category
   ...
   for i = 1:trail
       ...
       save(['./rgbdsubset_depth_acc_c_' num2str(dic_first.patchsize) 'x' num2str(dic_first.patchsize) '_second.mat'],'acc_c', 'predictlabel', 'testlabel');
...
if instance
   ...
   save(['./rgbdsubset_depth_acc_i_' num2str(dic_first.patchsize) 'x' num2str(dic_first.patchsize) '_second.mat'],'acc_i', 'predictlabel', 'testlabel');
