...
void vis_pointcloud2rangeimage(pcl::PointCloud<pcl::PointXYZI>::Ptr &cloud_in, std::vector<pcl::PointIndices> &cluster_indices)
{
    ...
    for (std::vector<pcl::PointIndices>::const_iterator it = cluster_indices.begin (); it != cluster_indices.end (); ++it)
    {
        ...
        pcl::PointCloud<pcl::PointXYZI>::Ptr sub_cluster(new pcl::PointCloud<pcl::PointXYZI>);
        ...
        range_image[i].createFromPointCloud(*sub_cluster.get(), angularResolution, maxAngleWidth, maxAngleHeight,
